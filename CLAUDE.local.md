...
**YOU ARE IN: `jaritanet/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/jaritanet/` (rig root) or other directories
...
**Your mail address:** `jaritanet/polecats/furiosa`
**Your rig:** jaritanet
**Your Witness:** `jaritanet/witness`
...
| Ask Witness for help  | `gt mail send jaritanet/witness -s "HELP" -m "..."` | ~~gt nudge witness~~                        |

---

## When to Ask for Help

Mail your Witness (`jaritanet/witness`) when:
...
```bash
gt mail send jaritanet/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
