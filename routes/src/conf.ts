...
export interface ServiceStackConf {
  path: string;
  stack?: string;
}
 ...
 *
 * @deprecated In favor of `ServiceOutput`.
 */
export interface LegacyServiceConf {
  /**
...
export interface ZoneConf {
   ...
   * Services to tunnel.
   *
   * @deprecated Use `ServiceOutput` instead.
   */
  services?: LegacyServiceConf[];
}
