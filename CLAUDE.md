...
- **`@jaritanet/hetzner`** — the VPS, its firewall rules, network tuning, k3s over SSH, Cilium as the CNI, and the upgrade Plans that carry the k3s version to nodes with no SSH
