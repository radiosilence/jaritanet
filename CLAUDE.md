...
- **`singbox/`** - Renders the sing-box client profile from `clients/singbox.template.json`, writes it to the file server's unguessable path, and pushes the URL + QR to Telegram on change
